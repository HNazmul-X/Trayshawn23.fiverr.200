...
const Header = () => {
    const LgButton = ({ icon, text }) => {
        return (
            <h1 className="pink-navyBlue-gd-btn display-5 fw-700-imp px-3 py-0 text-uppercase">
                {icon}
                {text}
            </h1>
        );
    ...
    return (
        <header id="header">
            ...
            <section id="buy-opensea" className="py-5">
                <div className="text-center pt-5">
                    <LgButton
                        icon={
                            <svg width={90} xmlns="http://www.w3.org/2000/svg" className="me-4" viewBox="0 0 90 90" fill="none">
                    ...
                    <div className="container-xxl px-4 mx-3 mx-lg-auto py-5">
                        <div className="row align-items-center image-text">
                            <div className="col-lg-6 order-1 order-lg-0 mt-5 mt-lg-0 text-lg-start text-center">
                                ...
                                <div className="desc">
                                    <div className="">
                                        {openseaData.desc.map((item) => (
                                            <p>{item}</p>
                                        ))}
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 image order-0 order-lg-1">
                                <img className="img-fluid" src={OPENSEA_RIGHT_IMAGE} alt="" />
                            </div>
                        </div>

                        <div className="text-center mt-5">
                            <h2 className=" pink-navyBlue-gd-btn py-0">
                                <svg width={90} xmlns="http://www.w3.org/2000/svg" className="me-4" viewBox="0 0 90 90" fill="none">
                                    <path d="M90 45C90 69.8514 69.8514 90 45 90C20.1486 90 0 69.8514 0 45C0 20.1486 20.1486 0 45 0C69.8566 0 90 20.1486 90 45Z" fill="transparent" />
                                    <path
                                        d="M22.2011 46.512L22.3952 46.2069L34.1015 27.8939C34.2726 27.6257 34.6748 27.6535 34.8043 27.9447C36.7599 32.3277 38.4475 37.7786 37.6569 41.1721C37.3194 42.5683 36.3947 44.4593 35.3544 46.2069C35.2204 46.4612 35.0724 46.7109 34.9152 46.9513C34.8413 47.0622 34.7164 47.127 34.5823 47.127H22.5432C22.2195 47.127 22.03 46.7756 22.2011 46.512Z"
